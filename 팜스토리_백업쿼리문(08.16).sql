...
INSERT INTO `bank_account` (`a_no`, `a_item_dist`, `a_item_name`, `a_c_no`, `a_balance`, `a_open_date`) VALUES
	('101-11-1001', 'S1', '자유저축예금', '730423-1000001', 370000, '2005-07-21'),
...
INSERT INTO `bank_customer` (`c_no`, `c_name`, `c_dist`, `c_phone`, `c_addr`) VALUES
	...
	('910912-2000005', '심사임당', 1, '010-1234-1005', '강원도 강릉시'),
...
INSERT INTO `bank_transaction` (`t_no`, `t_a_no`, `t_dist`, `t_amount`, `t_datetime`) VALUES
	...
	(3, '101-11-1001', 2, 300000, '2022-08-21 04:26:52'),
...
INSERT INTO `member` (`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES
	...
	('a109', '허균', '010-1234-1009', '부장', 104, '2023-06-16 16:39:48'),
...
CREATE TABLE IF NOT EXISTS `book` (
  `bookId` int NOT NULL,
  `bookName` varchar(20) NOT NULL,
  `publisher` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `price` int DEFAULT '0',
  PRIMARY KEY (`bookId`),
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  PRIMARY KEY (`orderId`,`bookId`,`custId`),
...
CREATE TABLE IF NOT EXISTS `publisher` (
  ...
  `pubHp` varchar(13) DEFAULT NULL,
  PRIMARY KEY (`pubName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 erd2.publisher:~6 rows (대략적) 내보내기
INSERT INTO `publisher` (`pubName`, `pubHp`) VALUES
...
-- erd4 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `erd4` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `erd4`;

-- 테이블 erd4.departments 구조 내보내기
...
-- 테이블 데이터 erd4.departments:~12 rows (대략적) 내보내기
...
-- 테이블 데이터 erd4.professors:~12 rows (대략적) 내보내기
INSERT INTO `professors` (`proNo`, `depNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`) VALUES
	...
	('P10102', 10, '계백', '740610-1234567', '010-1102-1975', 'haevack@hg.ac.kr', '서울'),
...
CREATE TABLE IF NOT EXISTS `register` (
  ...
  KEY `fk_Register_Lectures1_idx` (`proNo`,`lecNo`),
  CONSTRAINT `fk_Register_Lectures1` FOREIGN KEY (`proNo`, `lecNo`) REFERENCES `lectures` (`proNo`, `lecNo`),
  CONSTRAINT `fk_Register_Student1` FOREIGN KEY (`stdNo`) REFERENCES `student` (`stdNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 erd4.register:~10 rows (대략적) 내보내기
INSERT INTO `register` (`stdNo`, `lecNo`, `proNo`, `regAttenScore`, `regMidScore`, `regFinalScore`, `regEtcScore`, `regTotal`, `regGrade`) VALUES
	('20101001', '101001', 'P10101', 51, 84, 69, NULL, 68, 'D'),
	('20101001', '101002', 'P10102', 91, 49, 73, NULL, 71, 'C'),
	('20101001', '101003', 'P10102', 14, 52, 19, NULL, 28, 'F'),
	('20111013', '111011', 'P11103', 39, 36, 62, NULL, 46, 'F'),
	('20111013', '111012', 'P11104', 2, 23, 8, NULL, 11, 'F'),
	('21231002', '231110', 'P23102', 70, 28, 26, NULL, 41, 'F'),
	('22401001', '401019', 'P40101', 49, 64, 71, NULL, 61, 'D'),
	('22401001', '421012', 'P42103', 65, 11, 58, NULL, 45, 'F'),
	('22421003', '311003', 'P31104', 59, 21, 28, NULL, 36, 'F'),
	('22421003', '421012', 'P42103', 75, 90, 24, NULL, 63, 'D');

-- 테이블 erd4.student 구조 내보내기
CREATE TABLE IF NOT EXISTS `student` (
  `stdNo` char(8) NOT NULL,
  `depNo` int NOT NULL,
  `proNo` char(6) NOT NULL,
  ...
  KEY `fk_Student_Professors1_idx` (`proNo`),
  KEY `fk_Student_Departments1_idx` (`depNo`),
  CONSTRAINT `fk_Student_Departments1` FOREIGN KEY (`depNo`) REFERENCES `departments` (`depNo`),
  CONSTRAINT `fk_Student_Professors1` FOREIGN KEY (`proNo`) REFERENCES `professors` (`proNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 erd4.student:~12 rows (대략적) 내보내기
...
-- 테이블 데이터 farmstory.article:~65 rows (대략적) 내보내기
INSERT INTO `article` (`no`, `parent`, `comment`, `cate`, `title`, `content`, `file`, `hit`, `writer`, `regip`, `rdate`) VALUES
	(6, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(7, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(8, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(9, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(10, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(11, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(12, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(13, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(14, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(15, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(16, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(17, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(18, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(19, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(20, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(21, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(29, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(30, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(31, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(32, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(33, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(34, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(35, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(36, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(37, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(38, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(39, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(40, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(41, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(42, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(43, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(44, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(60, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(61, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(62, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(63, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(64, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(65, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(66, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(67, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(68, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(69, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(70, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(71, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(72, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(73, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(74, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(75, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(76, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(77, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(78, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(79, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(80, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(81, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(82, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(83, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(84, 0, 0, 'story', '농작물 이야기 테스트1', '테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:54:40'),
	(85, 0, 0, 'event', '이벤트 테스트 1', '이벤트 테스트1입니다.', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:04'),
	(86, 0, 0, 'notice', '커뮤니티 공지사항1', '공지사항', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:17'),
	(87, 0, 0, 'notice', '커뮤니티 공지사항 테스트2', '관리자입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:55:40'),
	(88, 0, 0, 'menu', '커뮤니티 오늘의 식단 1', '테스트1입니다', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:02'),
	(89, 0, 0, 'chef', '커뮤니티 나도요리사 테스트1', '테스트1', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:18'),
	(90, 0, 0, 'grow', '농작물이야기- 텃밭가꾸기 테스트1', 'ㅌㅌ', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:36'),
	(91, 0, 0, 'grow', '농작물이야기 - 텃밭가꾸기 2', '테스트 2', 0, 0, 'apple', '0:0:0:0:0:0:0:1', '2023-08-17 12:56:52'),
	(92, 0, 0, 'story', '농작물 테스트', '테스트1', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-18 09:28:14');
...
INSERT INTO `user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `role`, `zip`, `addr1`, `addr2`, `regip`, `regDate`, `leaveDate`) VALUES
	('apple', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '김사과', '사과씨', 'apple@naver.com', '010-1234-5859', 'MANAGER', '45871', '', '', '0:0:0:0:0:0:0:1', '2023-08-16 13:47:36', NULL),
	('banana', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '이바나', '바나나', 'banana@gmail.com', '010-7895-9946', 'USER', '41256', '', '', '0:0:0:0:0:0:0:1', '2023-08-17 08:58:14', NULL),
	('gussla', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '이현정', '현정이', 'guswjd@gmail.com', '010-1264-8495', 'USER', '41256', '', '', '0:0:0:0:0:0:0:1', '2023-08-16 13:52:29', NULL);
...
INSERT INTO `account` (`acc_id`, `cust_jumin`, `acc_type`, `acc_balance`, `acc_card`, `acc_register_date`) VALUES
	...
	('1011-1001-1002', '890530-1234567', '자유입출금', 376000, 'Y', '2020-01-21 13:00:02'),
	('1011-1001-1003', '790413-1234567', '자유입출금', 1200000, 'Y', '2020-01-21 13:00:02'),
	('1011-1001-1007', '721128-1234567', '자유입출금', 7620500, 'Y', '2020-01-21 13:00:02'),
	('1011-1001-1009', '891209-1234567', '자유입출금', 1763000, 'Y', '2020-01-21 13:00:02'),
	('1011-1002-1005', '840615-1234567', '자유입출금', 820000, 'Y', '2020-01-21 13:00:02'),
	('1011-1002-1006', '651021-1234567', '자유입출금', 3520000, 'Y', '2020-01-21 13:00:02'),
	('1011-2001-1004', '660912-1234567', '정기적금', 1000000, 'N', '2020-01-21 13:00:02'),
	('1011-2001-1008', '920907-1234567', '정기적금', 3400000, 'N', '2020-01-21 13:00:02'),
	('1011-2001-1010', '770314-1234567', '정기적금', 1080000, 'N', '2020-01-21 13:00:02');

-- 테이블 finance.card 구조 내보내기
CREATE TABLE IF NOT EXISTS `card` (
  `card_no` char(14) NOT NULL,
  `cust_jumin` varchar(20) NOT NULL,
  `acc_id` varchar(14) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `card` (`card_no`, `cust_jumin`, `acc_id`, `card_register_date`, `card_limit_money`, `card_approve_date`, `card_type`) VALUES
	...
	('2221-1001-1008', '920907-1234567', '-', '2020-10-21', 5000000, '2020-11-15', 'credit'),
	...
	('2711-1001-1004', '660912-1234567', '-', '2020-04-13', 1000000, '2020-05-10', 'credit'),
	('2781-1001-1006', '651021-1234567', '1011-1002-1006', '2020-07-28', 10000000, '2020-08-15', 'check'),
	('2789-1001-1010', '770314-1234567', '-', '2020-09-07', 1000000, '2020-10-10', 'credit');
...
INSERT INTO `customer` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) VALUES
	...
	('660912-1234567', '원빈', '대전', '1966-09-12', 'one@daum.com', '010-2104-6609', '배우'),
	('721128-1234567', '유재석', '부산', '1972-12-28', NULL, '010-1101-7211', '개그맨'),
	...
	('840615-1234567', '고소영', '대구', '1976-06-15', 'goso@daum.net', '010-4101-8406', '회사원'),
	...
	('920907-1234567', '강호동', '부산', '1992-09-07', NULL, '010-1101-9209', '개그맨');
...
INSERT INTO `transaction` (`trans_id`, `trans_acc_id`, `trans_type`, `trans_message`, `trans_money`, `trans_date`) VALUES
	(1, '1011-1001-1001', '입금', '2월 정기급여', 3500000, '2020-02-10 13:00:02'),
	(2, '1011-1001-1003', '출금', 'ATM 출금', 300000, '2020-02-10 13:00:02'),
	(3, '1011-1001-1002', '입금', '2월 급여', 2800000, '2020-02-10 13:00:02'),
	(4, '1011-1001-1007', '출금', '2월 공과금', 116200, '2020-02-10 13:00:02'),
	(5, '1011-1002-1005', '출금', 'ATM 출금', 50000, '2020-02-10 13:00:02'),
	(6, '1011-1001-1007', '입금', '홍길동 이체', 400000, '2020-02-10 13:00:02'),
	(7, '1011-1001-1007', '출금', '2월 관리비', 145000, '2020-02-10 13:00:02'),
	(8, '1011-1001-1002', '입금', '홍길동 입금', 200000, '2020-02-10 13:00:02'),
	(9, '1011-1001-1009', '입금', '연말정산 환급', 112000, '2020-02-10 13:00:02'),
	(10, '1011-1002-1006', '출금', 'ATM 출금', 30000, '2020-02-10 13:00:02');
...
-- 테이블 데이터 hospital.charts:~5 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `doctors` (
  `doc_id` char(7) NOT NULL,
  `dep_no` char(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `doctors` (`doc_id`, `dep_no`, `doc_name`, `doc_birth`, `doc_gen`, `doc_pos`, `doc_phone`, `doc_email`) VALUES
	...
	('D107103', '107', '이이', '1991-09-07', 'M', '전문의', '010-7103-1992', 'leelee@bw.com'),
...
CREATE TABLE IF NOT EXISTS `nurses` (
  ...
  KEY `fk_Nurses_Departments_idx` (`dep_no`),
  CONSTRAINT `fk_Nurses_Departments` FOREIGN KEY (`dep_no`) REFERENCES `departments` (`dep_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `nurses` (`nur_id`, `dep_no`, `nur_name`, `nur_birth`, `nur_gender`, `nur_pos`, `nur_phone`, `nur_email`) VALUES
	...
	('N106101', '105', '공유', '1965-11-21', 'M', '간호사', '010-5101-6511', 'gong@bw.com'),
	('N107101', '107', '이병헌', '1972-12-28', 'M', '간호사', '010-6101-7212', 'byung@bw.com'),
	('N108101', '108', '송중기', '1992-10-07', 'M', '간호사', '010-7103-9210', 'jung@bw.com');
...
CREATE TABLE IF NOT EXISTS `patients` (
  ...
  `pat_email` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  KEY `writer` (`writer`),
  CONSTRAINT `article_ibfk_1` FOREIGN KEY (`writer`) REFERENCES `user` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=33216 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 테이블 데이터 jboard.article:~384 rows (대략적) 내보내기
INSERT INTO `article` (`no`, `parent`, `comment`, `cate`, `title`, `content`, `file`, `hit`, `writer`, `regip`, `rdate`) VALUES
	...
	(33177, 0, 0, 'free', '테스트입니다.', '테스트 내용 변경이요', 0, 0, 'hello', '0:0:0:0:0:0:0:1', '2023-08-08 11:31:20'),
	...
	(33196, 0, 3, 'free', '글글글', '테스트입니다.', 0, 0, 'hellojava', '0:0:0:0:0:0:0:1', '2023-08-08 12:05:16'),
	...
	(33213, 33196, 0, 'free', NULL, '총 다섯번째 댓글333', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-09 17:32:23'),
	(33214, 33196, 0, 'free', NULL, '댓글 추가 ~', 0, 0, 'gussla', '0:0:0:0:0:0:0:1', '2023-08-10 18:15:34');
...
-- 테이블 데이터 jboard.user:~5 rows (대략적) 내보내기
INSERT INTO `user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `role`, `zip`, `addr1`, `addr2`, `regip`, `regDate`, `leaveDate`) VALUES
	('a101', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '홍길동', '길동', 'hg1555@gmail.com', '010-5555-6666', 'USER', '45846', '부산광역시 부산진구 행복동 웃음아파트', '116-2650', '0:0:0:0:0:0:0:1', '2023-08-02 13:36:15', NULL),
	('abc102', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '유관순', '관순', 'yg1555@gmail.com', '010-1234-7777', 'USER', '12658', '서울특별시 영등포구 행복동 ', '155-4895', '0:0:0:0:0:0:0:1', '2023-08-02 13:37:40', NULL),
	('apple', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '김사과', '사과씨', 'tkrhk@naver.com', '010-1234-5748', 'USER', '45871', '', '', '0:0:0:0:0:0:0:1', '2023-08-16 13:39:36', NULL),
	('gussla', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '벨라리', '현정', 'gussla@gmail.com', '010-1234-2225', 'USER', '41256', '대구 동구 동대구로 475', '', '0:0:0:0:0:0:0:1', '2023-08-03 17:59:02', NULL),
	('hello', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '김유순', '유순', 'ys102@gmail.com', '010-1234-5555', 'USER', '10548', '경기 고양시 덕양구 서오릉로532번길 5', '', '0:0:0:0:0:0:0:1', '2023-08-04 11:12:54', NULL),
	('hellojava', 'eacff39f5b2445e6ee415c413ece1a131e5b4f387d6440ca9bcbbe11692c6088', '김유순', '유슌이', 'yssss102@gmail.com', '010-1234-7778', 'USER', NULL, '서울 관악구 남부순환로256가길 3', '', '0:0:0:0:0:0:0:1', '2023-08-04 15:30:53', NULL),
	('hiiiiiiiiii', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '김신유', '신유', 'uuuu123@naver.com', '010-1234-5985', 'USER', '08769', '서울 관악구 시흥대로166길 14', '', '0:0:0:0:0:0:0:1', '2023-08-04 11:14:10', NULL);
...
INSERT INTO `customer` (`custId`, `name`, `hp`, `addr`, `rdate`) VALUES
	...
	('gussla', '이현정', '010-1234-5678', '부산', '2023-07-13');
...
INSERT INTO `order` (`OrderNo`, `orderId`, `orderProduct`, `orderCount`, `orderDate`) VALUES
	...
	(11, 'gussla', 2, 30, '2023-07-14 11:37:55'),
	(12, 'gussla', 3, 10, '2023-07-14 11:40:04'),
	(13, 'gussla', 5, 12, '2023-07-14 11:40:12');

-- 테이블 shop.product 구조 내보내기
CREATE TABLE IF NOT EXISTS `product` (
  `prodNo` int NOT NULL,
  `prodName` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `carts` (
  ...
  PRIMARY KEY (`carNo`,`userId`,`prodNo`),
...
INSERT INTO `carts` (`carNo`, `userId`, `prodNo`, `cartProdCount`, `cartProdDate`) VALUES
...
INSERT INTO `points` (`pointNo`, `userId`, `point`, `pointDesc`, `pointDate`) VALUES
	...
	(7, 'user1', 2000, '이벤트 응모 2000 적립', '2022-01-10 10:50:12'),
	(8, 'user1', 2615, '상품구매 5% 적립', '2022-01-10 10:50:12'),
...
-- 테이블 데이터 shopping.users:~9 rows (대략적) 내보내기
...
-- 테이블 데이터 userdb.sales:~29 rows (대략적) 내보내기
...
-- 테이블 데이터 userdb.tbluser:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 userdb.user1:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 userdb.user7:~2 rows (대략적) 내보내기
